...
export const Header = () => {
	...
	return (
		<>
			...
			<header
				className={`flex flex-col max-lg:!hidden w-full top-0 right-0 rounded-none border-white border-b-neutral-200 fixed duration-300 px-0 lg:!px-6 z-[100] bg-white shadow-sm border`}
			>
