...
export default function OrderItemEditPage() {
	...
	const submitUpdate = () => {
		...
		updateItem.fetchData({ ...calcPayload, passports: editState.passports, assets: Object.values(editState.assetsByDoc).flat(), desiredDeliveryDate: editState.desiredDeliveryDate, isOfficial: editState.isOfficial });
	};
	...
	return (
		<div className="w-full bg-gradient-to-b from-secondary/[0.04] to-transparent py-8 lg:py-10 px-4">
			<div className="max-w-5xl mx-auto flex flex-col gap-8">
				...
				<div className="rounded-3xl border border-neutral-200 bg-white shadow-sm p-5 lg:p-10 min-h-[420px]">
					...
					>
						...
						{step === 12 && (
							<div className="flex flex-col gap-8">
								<StepHeader title="خلاصه آیتم" subtitle="جزئیات نرخ این آیتم را بررسی و آن را ذخیره کنید" />
								<div className="max-w-3xl mx-auto w-full">
											...
											return (
												<div className="flex flex-col gap-5">
													...
													<div className="rounded-2xl border border-neutral-200 bg-neutral-50/40 p-5 flex flex-col gap-3">
														...
														<SummaryRow label="مبلغ کل آیتم" value={bd.summary.totalPrice} bold />
													</div>
